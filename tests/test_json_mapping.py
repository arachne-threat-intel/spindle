...
THREAD_COUNTRY_CONF = (
    "https://raw.githubusercontent.com/arachne-threat-intel/thread/main/threadcomponents/conf/countries-iso2.json"
)
    ...
    def test_country_values(self):
        ...
        for group, entry in self.loaded_json.items():
            ...
            for entry_country in entry_countries:
                error_msg = f"Country '{entry_country}' under '{group}' is not a valid country code."
